...
final ptHelpCatalogCopy = HelpCatalogCopy({
  ...
  HelpTopicIds.grammarEditorOverview: HelpNodeCopy(
    ...
    body:
        ...
        'Nome da gramática e Símbolo inicial, adicione regras pelos campos Variável '
        'e Produção e abra Analisar ou '
  ...
  HelpTopicIds.grammarEditorProductionSymbols: HelpNodeCopy(
    ...
    body:
        ...
        'um símbolo como S em cada Variável; letras maiúsculas '
  ...
  HelpTopicIds.grammarEditorProductionRowsAndAlternatives: HelpNodeCopy(
    ...
    body:
        ...
        'símbolos maiores; se qualquer alternativa usar espaços, todo o '
        'campo é lido assim, e num | id | ( Expr ) mantém num e id inteiros. '
        'Para '
        'remover ambiguidades, digite um símbolo no campo Símbolo e toque em '
        'Não-terminal ou Terminal; os chips abaixo mostram não-terminais em '
        'amarelo e terminais em verde, e tocar em um chip troca o tipo. '
        'Digite \\| para inserir uma barra vertical literal. '
  ...
  HelpTopicIds.grammarEditorProductionLambda: HelpNodeCopy(
    ...
    body:
        ...
        'entrada vazia. Em Produção, selecione Inserir ε ou '
