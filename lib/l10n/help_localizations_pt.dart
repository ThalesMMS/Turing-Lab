const ptHelpUiCopy = {
  ...
  'unrestrictedGrammarExampleContextCopying': 'Padrão de cópia com contexto',
  'unrestrictedGrammarExampleTmGenerated': 'Gramática irrestrita gerada por MT',
  'lSystemExampleKochCurve': 'Curva de Koch',
  'lSystemExampleSierpinskiTriangle': 'Triângulo de Sierpiński',
  'lSystemExampleDragonCurve': 'Curva do dragão',
  'lSystemExampleFractalPlant': 'Planta fractal',
  'lSystemExampleBranchingTree': 'Árvore ramificada',
  'lSystemExampleSeededContextTurtle': 'Tartaruga contextual com semente',
...
const ptHelpArticleBodies = {
  ...
  'grammar':
      ...
      'Adicione produções com um não terminal à esquerda e uma sequência de terminais ou não terminais à direita. Use ε para a cadeia vazia. '
  ...
  'fileOperations':
      'O Turing Lab oferece fluxos de arquivo por espaço de trabalho.\n\n'
...
const ptHelpBodies = {
  ...
  'concept_epsilon':
      'Uma transição epsilon permite que um AFN mude de estado sem consumir símbolo de entrada. Ela é escrita como ε e usada para criar caminhos de computação simultâneos.',
  'concept_pda':
